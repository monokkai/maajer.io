    ...
    <BlogPage>
      <motion.div className="flex flex-col gap-6" {...fade(0)}>
        ...
        <motion.p className="text-sm leading-relaxed" {...fade(0.2)}>
          ...
          in Lithuania, and now living in Alicante, Spain. I&apos;m{" "}
          {currentYear()} {""} years old, and I&apos;ve been obsessed with how
          things work under the hood for as long as I can remember.
        </motion.p>
